...
// POST /payments/webhook — notificaciones de Mercado Pago (público, sin idempotency middleware:
// la idempotencia se maneja a nivel de máquina de estados dentro del servicio)
